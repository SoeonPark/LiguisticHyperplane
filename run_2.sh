...
#
# Usage:
#   bash run_2.sh               # full pipeline
#   bash run_2.sh probe         # probe only (skip data/extract if cached)
#   bash run_2.sh data          # data filtering only

# nohup bash run_2.sh > gemma-2-9b.log 2>&1 &
# nohup bash run_2.sh probe > gemma-2-9b_probe.log 2>&1 &
# nohup bash run_2.sh visualize > gemma-2-9b_visualize.log 2>&1 &
...
TAG="case13_full_suite"                  # 추가 suffix 없음
